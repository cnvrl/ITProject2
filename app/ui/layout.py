...
def create_layout(
    ...
    datasets = dashboard_data.unique_values(
        "dataset"
    )

    trackers = dashboard_data.unique_values(
        "tracker"
    )

    regions = dashboard_data.unique_values(
        "region"
    )

    scenarios = dashboard_data.unique_values(
        "scenario"
    )
                        ...
                        children=[
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    html.P(
                                        (
                                            f"{len(dashboard_data.tracks):,} "
                                            "tracks and "
                                            f"{len(dashboard_data.points):,} "
                                            "observations loaded."
                                        )
                                    ),
                                ],
